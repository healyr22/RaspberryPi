...
var maybeMockRestore = function (a) {
    return a.mockRestore && typeof a.mockRestore === 'function' ? a.mockRestore() : undefined;
};
/**
 ...
 */
exports.mockProcessExit = function (err) { return spyOnImplementing(process, 'exit', (err ? function () { throw err; } : (function () { }))); };
/**
 * Helper function to create a mock of the Node.js method
 * `process.stdout.write(text: string, callback?: function): boolean`.
 */
exports.mockProcessStdout = function () { return spyOnImplementing(process.stdout, 'write', (function () { return true; })); };
/**
 * Helper function to create a mock of the Node.js method
 * `process.stderr.write(text: string, callback?: function): boolean`.
 */
exports.mockProcessStderr = function () { return spyOnImplementing(process.stderr, 'write', (function () { return true; })); };
/**
 * Helper function to create a mock of the Node.js method
 * `console.log(message: any)`.
 */
exports.mockConsoleLog = function () { return spyOnImplementing(console, 'log', (function () { })); };
/**
 ...
 */
exports.mockedRun = function (callers) { return function (f) {
    var mocks = {};
 ...
 * Every provided mock will be automatically restored when this function returns.
 */
exports.asyncMockedRun = function (callers) { return function (f) { return __awaiter(void 0, void 0, void 0, function () {
